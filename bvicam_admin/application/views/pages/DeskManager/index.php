...
<div class="col-sm-12 col-md-12 ">
    ...
    <div class="row">
        <form class="form-horizontal" enctype="multipart/form-data" method = "post">
            ...
            <div class="form-group">
                <label for="searchvalue" class="col-sm-3 control-label"><span class="glyphicon "></span> Search Value</label>
                <div class="col-sm-9">
                    <input type="text" name = "searchvalue" maxlength="50" class="form-control" value="<?php echo set_value('searchvalue'); ?>" id="searchvalue" placeholder="Enter value">
                </div>
