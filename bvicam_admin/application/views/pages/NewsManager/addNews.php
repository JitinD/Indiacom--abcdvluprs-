        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form class="form-horizontal"
                ...
                <div class="form-group">
                    <label for="title" class="col-sm-3 control-label"><span
                            class="glyphicon glyphicon-asterisk text-danger"></span> Title</label>

                    <div class="col-sm-9">
                        <input type="text" name="title" id="title" class="form-control"
                               value="<?php echo set_value('title'); ?>" placeholder="Enter Title">
                    </div>
                ...
                <div class="form-group">
                    <label for="content" class="col-sm-3 control-label"><span
                            class="glyphicon glyphicon-asterisk text-danger"></span> Content</label>

                    <div class="col-sm-6">
                        <textarea name="content" class="form-control" value="<?php echo set_value('content'); ?>"
                                  id="content" rows="5" placeholder="Enter Content"></textarea>
                    </div>
                    <div class="col-sm-8 col-sm-offset-4 text-danger h5" id="errorText">
                ...
                <div class="form-group">
                    <label for="publishDate" class="col-sm-3 control-label"><span
                            class="glyphicon glyphicon-asterisk text-danger"></span> Publish Date</label>

                    <div class="col-sm-6">
                        <input type="date" name="publishDate" class="form-control"
                               value="<?php echo set_value('publishDate'); ?>" id="publishDate">
                    </div>
                    <div class="col-sm-8 col-sm-offset-4 text-danger h5" id="errorText">
