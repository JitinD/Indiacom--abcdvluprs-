...
<html>
<body>
    <center>Minor Revisions required based on Detailed Review</center>
    <p>
    ...
    <p>
        The reviews of your Paper are now complete and it is our pleasure to inform you that the consensual decision of the Technical Programme Committee (TPC) is <span style="color: #ff0000; font-weight: bold;">to accept the above mentioned paper for presentation and publication in INDIACom - 2016</span>, subject to minor revisions, in response to the comments of the TPC, which are given at the end of this notification. You are informed to submit the thoroughly revised paper for re-consideration at the earliest but not later than <span style="color: #ff0000; font-weight: bold;">10 days</span>. Upon the receipt of the suitably revised paper, it will again be reviewed by the same set of reviewers. It is, therefore, requested to create a master list of revisions/rebuttals, responding to each point raised by the reviewers, in the format attached herewith. If you feel that the reviewers' comment does not warrant a revision, please prepare a reasoned rebuttal to their comment, in the same format.
    </p>
    <p>
