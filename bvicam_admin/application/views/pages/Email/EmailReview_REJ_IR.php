...
The reviews of your paper are now complete and it is regretted to inform you that the above mentioned paper is rejected in its current form.<br/><br/>

You may revise your paper in response to the comments of the Board of Referees (BoR), which are given at the end of this notification, and submit the thoroughly revised paper for re-consideration, if you wish to do so. In order to re-submit the revised paper, please login with your member ID and password at http://www.bvicam.ac.in/indiacom/login.asp and click Submit Revised Paper link against the Paper ID in the Member Area.<br/><br/>
