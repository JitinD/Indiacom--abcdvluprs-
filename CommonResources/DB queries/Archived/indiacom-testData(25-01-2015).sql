...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2015 at 01:05 PM
...
CREATE TABLE IF NOT EXISTS `payment_master` (
  ...
  `payment_head` int(2) DEFAULT NULL,
...
(13, 18, NULL, 2, '33', 2, 0, 6000, 13, NULL, '2015-01-25 11:47:13', 0),
(14, 18, NULL, 10, '33', 8, 0, 2000, 49, NULL, '2015-01-25 11:47:13', 0);
...
(18, '33', 'HDFC', '324554', 2, 8000, '2015-01-25', 1, 8000, 0, 1, '', NULL, '2015-01-25 09:59:01', 0);
