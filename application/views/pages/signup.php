		...
		<div class="col-md-6 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0">
			<form class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea class="form-control" id="address" placeholder="Enter full address"></textarea>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="tel" class="form-control" id="fax" placeholder="Enter Fax Number">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="csimembershipno" placeholder="Enter CSI Membership Number">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="ietemembershipno" placeholder="Enter IETE Membership Number">
					</div>
				</div>
				<div class="form-group">
