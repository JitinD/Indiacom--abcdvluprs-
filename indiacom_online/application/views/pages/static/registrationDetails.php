        ...
        <div class="row">
            <div class="col-md-12">
				...
				<table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        <td><strong>Teachers/ Research Scholars</strong></td>
						<td>6,000.00</td>
						<td>7,000.00</td>
						<td>7,000.00</td>
						<td>8,000.00</td>
                ...
                <p>
                    Maximum paper length is of 6 printed pages. However, the authors can extend maximum 1 page with over length page charge, of Rs. 2,000/- (for Indian participants) and US$ 100/- (for International participants).
                </p>
				<p>
				...
				<p>
					*IEEE/IET/CSI/IETE/IE(I)/ISTE Members must mention their membership number and also attach a copy of the membership card or any other proof of valid membership.<br/>
					#Bonafide students as on 31st January, 2016, must submit the Bonafide Certificate from their Institute / College /Department. Students will not be given the hard copy of the Conference Proceedings. Soft copy will only be given. 
				</p>
