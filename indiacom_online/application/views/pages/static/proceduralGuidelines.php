<div class="row contentBlock-top">
    ...
    <div class="col-lg-10 col-md-9 col-sm-9 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <p>Dear user / author, <br/>Welcome to INDIACom. In order to submit a paper through this website, you
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p>
                            ...
                            you.And it is <strong>Free!</strong>
                            Please skip this step if you are already a member.
                        </p>

                        <p>
                            Your e-mail account, provided by you in the membership form is considered as <strong>registered e-mail ID</strong> by us, and the same would be used by us for further communication with you. To begin with, your <strong>Member ID</strong> and <strong>Password</strong> would be mailed to you. Please mail us, using your registered mail ID, at <a href="mailto:conference@bvicam.ac.in">conference@bvicam.ac.in</a> in case you don't receive this e-mail.
                        </p>
