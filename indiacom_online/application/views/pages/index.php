        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="2000">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="/<?php echo PATH ?>assets/images/OldIndiacom/INDIACom2007.jpg" alt="..." class="carousel-image">
                    <div class="carousel-caption h1">
                        INDIACom 2007
                    </div>
                </div>
                <div class="item">
                    <img src="/<?php echo PATH ?>assets/images/OldIndiacom/INDIACom2008.jpg" alt="..." class="carousel-image">
                    <div class="carousel-caption h1">
                        INDIACom 2008
                    </div>
                </div>
                <div class="item">
                    <img src="/<?php echo PATH ?>assets/images/OldIndiacom/INDIACom2009.jpg" alt="..." class="carousel-image">
                    <div class="carousel-caption h1">
                        INDIACom 2009
                    </div>
                </div>
                <div class="item">
                    <img src="/<?php echo PATH ?>assets/images/OldIndiacom/INDIACom2010.jpg" alt="..." class="carousel-image">
                    <div class="carousel-caption h1">
                        INDIACom 2010
                    </div>
                </div>
                <div class="item">
                    <img src="/<?php echo PATH ?>assets/images/OldIndiacom/INDIACom2011.jpg" alt="..." class="carousel-image">
                    <div class="carousel-caption h1">
                        INDIACom 2011
                    </div>
                </div>
                <div class="item">
                    <img src="/<?php echo PATH ?>assets/images/OldIndiacom/INDIACom2012.jpg" alt="..." class="carousel-image">
                    <div class="carousel-caption h1">
                        INDIACom 2012
                    </div>
                </div>
