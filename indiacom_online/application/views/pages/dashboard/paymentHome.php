...
<div id="step1">
    ...
    <span class="h5 center-block text-success">
        Transaction Date
        <input type="date" class="form-control" style="width: 180px; display: inline;" value="<?php echo $transDate; ?>" id="transDate">
    </span>
    <?php
                                    ...
                                    <span>
                                        <input type="radio" class="radio"
                                            ...
                                            <?php if(!isset($papersInfo[$paper->paper_id]['ep'])) echo "checked"; ?>
                                               value="BR" class="radio" <?php if(!isset($papersInfo[$paper->paper_id]['ep'])) echo "disabled"; ?>>
                                        Basic Registration with <?php echo $discount->discount_type_name; ?> Discount
                                ...
                                foreach($paperWiseDiscount[$paper->paper_id] as $paperDiscount)
                                {
                                    ...
                                    <span>
                                        <input type="radio" class="radio"
                                            ...
                                            <?php if(!isset($papersInfo[$paper->paper_id]['ep'])) echo "checked"; ?>
                                               value="BR" class="radio" <?php if(!isset($papersInfo[$paper->paper_id]['ep'])) echo "disabled"; ?>>
                                        Basic Registration with <?php echo $paperDiscount->discount_type_name; ?> Discount
                                        <input type="hidden" value="<?php
                            ...
                            <span>
                                <input type="radio"
                                    ...
                                    <?php if(!isset($papersInfo[$paper->paper_id]['br'])) echo "checked"; ?>
                                       value="EP" class="radio" <?php if(!isset($papersInfo[$paper->paper_id]['br'])) echo "disabled"; ?>>
                                Extra Paper
