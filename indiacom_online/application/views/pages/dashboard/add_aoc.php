<div class="container-fluid contentBlock-top">
    <div class="row">
        <div class="col-md-9 col-sm-9 col-xs-12">
            <span class="h3 text-theme">Special Session - Add AOC</span>
				...
				<div class="col-md-12">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="<?php echo $sid;?>" method="post">
						...
						<div class="form-group">
                            <label for="profile" class="col-sm-3 control-label">Add Aoc</label>
                            <div class="col-sm-9">
                                <input tpe="text" class="form-control" name="aoc" id="aoc" value="<?php echo set_value('aoc');?>" />
                            </div>
