...
$privilege['Page']['Dashboard']['downloadBiodata'] = array('D11');  //The download endpoints using the same privilege. If ever necessary you can have different privilege for each of them.
$privilege['Page']['Dashboard']['downloadPaperVersion'] = array('D11');
$privilege['Page']['Dashboard']['downloadComplianceReport'] = array('D11');
$privilege['Page']['Dashboard']['downloadReviewerComments'] = array('D11');
