...
class Registration extends CI_Controller
{
    ...
    {
        //$this->load->view('pages/Email/EmailActiveCode.php', array("activation_code"=>"sds", "member_id"=>2232));
        $this->load->view('pages/Email/ListOfServices.php', array("member_name"=>"Mr. Saurav Deb P.", "member_id"=>7410, "member_password"=>1234));
    }
